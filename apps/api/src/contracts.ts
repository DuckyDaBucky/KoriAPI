...
export const restContracts: RestContractEntry[] = [
  ...
  { method: "DELETE", path: "/v1/auth/invitations/:id", auth: "admin", summary: "Revoke a workspace invitation" },
  ...
  { method: "GET", path: "/v1/admin/dashboard-views", auth: "admin", summary: "List saved dashboard views" },
  { method: "POST", path: "/v1/admin/dashboard-views", auth: "admin", summary: "Save a dashboard view" },
  { method: "DELETE", path: "/v1/admin/dashboard-views/:id", auth: "admin", summary: "Delete a dashboard view" },
  { method: "POST", path: "/v1/admin/test-console", auth: "admin", summary: "Run a safe admin API test request" },
